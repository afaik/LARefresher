...
class Line(object):
    ...
    def __eq__(self, l):
        ...
        x0 = self.basepoint
        y0 = l.basepoint
        connecting_vector = x0.minus(y0)
        return self.normal_vector.is_orthogonal_to(connecting_vector)
    ...
    def intersection_with(self, l):
        try:
            ...
            one_over_denum = Decimal('1') / (A*D - B*C)
            return Vector([x_numerator, y_numerator]).times_scalar(one_over_denum)
